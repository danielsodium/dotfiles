...
-- Keybinding
vim.keymap.set({ "n" }, "<space>t", persistent_term, { desc = "Toggle persistent terminal" })
vim.keymap.set({ "n" }, "<space>r", build_term, { desc = "Toggle build terminal" })
vim.keymap.set({ "n" }, "<space>st", stupid_term, { desc = "stupid" })
